 ...
 */
public record ScreenCursorPayload(UUID vm, int x, int y, boolean visible, int hotX, int hotY, int w, int h, byte[] rgba) implements Payload {
	public static final ResourceLocation ID = VirtualMinecraft.id("screen_cursor");
	public static final int MAX_SIZE = 32;

	public ScreenCursorPayload(final FriendlyByteBuf buf) {
