...
public final class VmConfig {
	...
	public void save(final CompoundTag out) {
	...
	public void load(final CompoundTag in) {
		name = Nbt.getStringOr(in, "name", name);
		memMb = Nbt.getIntOr(in, "memMb", memMb);
		cpus = Nbt.getIntOr(in, "cpus", cpus);
		diskGb = Nbt.getIntOr(in, "diskGb", diskGb);
		iso = Nbt.getStringOr(in, "iso", iso);
		uefi = Nbt.getBooleanOr(in, "uefi", uefi);
		bootFromCd = Nbt.getBooleanOr(in, "bootFromCd", bootFromCd);
		vga = Nbt.getStringOr(in, "vga", vga);
		nic = Nbt.getStringOr(in, "nic", nic);
		extraArgs = Nbt.getStringOr(in, "extraArgs", extraArgs);
		autostart = Nbt.getBooleanOr(in, "autostart", autostart);
		wakeThreshold = Nbt.getIntOr(in, "wakeThreshold", wakeThreshold);
		redstoneSleep = Nbt.getBooleanOr(in, "redstoneSleep", redstoneSleep);
		suspend = Nbt.getBooleanOr(in, "suspend", suspend);
		sanitize();
	}
