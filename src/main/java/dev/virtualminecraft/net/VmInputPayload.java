...
public record VmInputPayload(UUID vm, List<Event> events) implements CustomPacketPayload {
	public static final Type<VmInputPayload> TYPE = new Type<>(VirtualMinecraft.id("vm_input"));
	public static final StreamCodec<FriendlyByteBuf, VmInputPayload> CODEC = CustomPacketPayload.codec(VmInputPayload::write, VmInputPayload::new);
	...
	private VmInputPayload(final FriendlyByteBuf buf) {
	...
	@Override
	public Type<VmInputPayload> type() {
		return TYPE;
	}
}
